...
using namespace std;
	...
	string bank_name, name0, name1="Hussieny Wazeer", name2="Ali Wazeer", name3="Cheahan Wazeer", store;
...
int main ()
{
	...
	cout<<"\n\n\n\n\n				    				    Welcome To QNB Bank ATM System "<<endl<<endl;
	cout<<"										 Enter PIN"<<endl;
	for (int i=1; i<=3; i++)
	{
	cout<<"				    						   "; cin>>pin;
